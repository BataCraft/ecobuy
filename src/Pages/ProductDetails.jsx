...
const ProductDetails = () => {
  ...
  const handleAddCart = () => {
    ...
    const found = cart.find((item) => item.id === singleProduct.id);
    if (found) {
          ...
          <div id="right" className='lg:w-[40%] h-full'>
            <div id="detail">
              ...
              <div className="flex items-center mt-2.5 mb-5">
                ...
                <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">{singleProduct.rating}</span>
              </div>
